      ...
      className="bg-[#1f1f1f] text-[#EBF1D5] border border-[#55554f] rounded-md p-2 text-base min-h-[40px] pl-3 flex-1"
                ...
                <div className="w-full gap-3">
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="uppercase">Received Requests</p>
                      ...
                      {received.map((req)=>{
                        return(
                          ...
                          <div className="flex flex-row w-full h-[50px] justify-between items-center">
                            ...
                            <p className="text-[20px] capitalize">{req.sender.name}</p>
                              <p className="text-[12px] lowercase">{req.sender.email}</p>
                            </div>
                  ...
                  {sent.length>0 && 
                  <div className="flex flex-col gap-2">
                    <p className="uppercase">Sent Requests</p>
                    <div className="w-full flex flex-col">
                    <hr />
                      {sent.map((req)=>{
                        return(
                          ...
                          <div className="flex flex-row w-full h-[50px] justify-between items-center">
                            <div className="flex flex-col h-full justify-around">
                              <p className="text-[20px] capitalize">{req.receiver.name}</p>
                              <p className="text-[12px] lowercase">{req.receiver.email}</p>
                            </div>                          
